  ...
  useEffect(() => {
    ...
    const config = {
      ...
      physics: {
        default: 'arcade',
        arcade: {
          gravity: { y: 220 }, // Moderate gravity - allows upward thrust
          debug: false
        }
      },
      scene: {
    ...
    function create() {
      ...
      const bg = this.add.image(400, 835, 'wichita-bg');
      bg.setOrigin(0.5, 1); // Anchor to bottom center
      // Make image much taller to push skyline down to canvas bottom
